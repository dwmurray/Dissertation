...
page 201 - Think its Anne that says this. Check it.
...
We want to model massive star forming regions in the Milky Way, so I choose the Mach Number ${\cal M} = 9$ and the virial parameter $\alpha_{vir} = 1.9$ respectively.

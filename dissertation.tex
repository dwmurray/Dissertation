...
In this dissertation, I explore the time-variable rates of star formation, using both numerical and analytic results. 
I discuss the dynamics of collapsing regions, the effect of proto-stellar jets, and development of software for use in RAMSES.
Motivated by the increasing rate of star formation found in recent numerical simulations by a number of workers, I performed high-resolution adaptive mesh refinement simulations of star formation in self-gravitating turbulently driven gas. 
I have run tens of simulations includying hydrodynamics (HD) alone, and HD and proto-stellar jet feedback.
As I follow the collapse of this gas, I find that the character of the flow changes at two radii, the disk radius $r_d$, and the radius $r_*$ where the enclosed gas mass exceeds the stellar mass. 
Accretion starts when the turbulent fluctuations on largescalse, near the driving scale produce a converging flow.
...
I show that jets change the normalization of the stellar mass accretion rate, but do not strongly affect the dynamics of star formation for pure HD.
In particular, $M_*(t) \propto (1 - f_{\rm jet})^2 (t-t_*)^2$ is the fraction of mass accreted onto the protostar, $f_{\rm jet}$ is the fraction ejected by the jet, and $(t-t_*)^2$ is the time elapsed since the formation of the first star.
The star formation efficiency is again nonlinear in time.
For typical values of $f_{\rm jet} \sim 0.1 - 0.3$ the accrection rate onto the star can be reduced by a factor of two or three. 

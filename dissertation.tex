...
\item vector notation is also used, where an arrow also indicates a vector, such as $\vec{x}$, $\vec{v}$, $\vec{a}$
...
\item I use $\vkep$ to indicate the $\sqrt{GM/\vec{r}}$ velocity.

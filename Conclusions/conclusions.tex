...
Like the disks modeled by Kratter et al. (2010), my simulated disks 
appear to be marginally gravitationally stable. If my disks are 
gravitationally unstable, at least part of the time, it would suggest 
that large scale gravitational torques could be responsible for 
transport of material and angular momentum in our simulations; this may 
also be true at early times in real protostellar disks. However, while I 
resolve the radial component of the accretion disk (by ~10 cells), I do 
not resolve the scale height of my disks. This lack of resolution calls 
...
angular momentum transport of (potentially) self-gravitating disks.
 ...
 From your published paper, you have a 16pc box with a resolution of 


32768, so 0.00048 pc. Your disks extend to about 0.01pc from when the 
rotational velocity is about half the escape velocity (roughly equal to 
the Keplerian velocity).

Like the disks modeled by \citet{2010ApJ...708.1585K},
my simulated disks appear to be marginally gravitationally stable. 
If my disks are 
gravitationally unstable, at least part of the time, it would suggest 
that large scale gravitational torques could be responsible for 
transport of material and angular momentum in our simulations; this may 
also be true at early times in real protostellar disks. 
However, while I resolve the radial component of the accretion disk (by $\sim10$ cells), 
I do not resolve the scale height of my disks. 
This lack of resolution calls into question the ability of my simulations to properly describe the 
angular momentum transport of (potentially) self-gravitating disks.

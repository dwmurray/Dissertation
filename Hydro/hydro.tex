...
%
\be 
Q = \frac{\vphi \sqrt{\vt^2 + c_s^2}}{\pi G r \Sigma}.
...
On the other hand if $Q < 1$ then it is at least plausible that graviational torques can transport angular momentum and hence drive accretion.
...
\be
a \approx \rho {\mathbf v}^2 / \Sigma_{\rm shock},
\ee
...
This gives an expontential distribution, \citet{2018ApJ...854...88R} show how this becomes a log-normal distribution of $\rho$.

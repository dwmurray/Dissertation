...
%
%While it is not always simple, I try to understand one concept, and then proceed to see how it is modified in the face of something new. 
...
%In essence, MC15 includes an extra equation for the evolution of the energy.
...
In the center, we place a region of higher density, i.e., a clump, with a Gaussian density distribution, $\rho(r) = \rho_m\exp(-r^2/r_0^2)$,  with maximum density of $\rho_m=3\times 10^{-16}\,{\rm g\,cm^{-3}}$ and a characteristic radius $r_0=0.017$ pc.
...
\begin{figure}[htb] %Figure 1 % Phil's test problem, 4 panels.
  ...
  \caption[Jet Test Problem]{Sequential plots of density structure perpendicular to the disk plane through the center of the sink particle. Columns from left to right show different times, from $t=0$ to $t=4820$ yrs, showing the effect of jet feedback on the test problem.}

...
\section{Where are stars birthed in the universe?}
...
Prior to presenting evidence, it is quite reasonable to believe that stars would result in these clouds; in order to accrete the large amount of matter in order to form a star, 
...
\section{What impact do stars have on their surrounding medium}

\section{How do we know the rate at which stars form?}

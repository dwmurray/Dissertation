...
On large scales, the leading candidate is stellar feedback, e.g. \citet{1986ApJ...303...39D}, in which supernovae limit the amount of dense gas. %, which is supposed to create a slow star formation rate on galactic scales.
On small scales, these include turbulent pressure support \citep{1992ApJ...396..631M} and support from magnetic fields \citep{1966MNRAS.132..359S,1976ApJ...207..141M}. %, which are envisioned to produce a slow star formation rate. %on small scales.
...
%While turbulence and magnetic support appear unable to slow the rate of star formation on small scales, it is still possible that understanding the small scale accretion physics may provide an avenue to explain the observed low efficiency of galaxy-scale star formation.  Along these lines,
...
%proportional to the density, i.e., that the gas was isothermal, or proportional to the density times the square of a prescribed function of radius (the square of the turbulent velocity, which was in turn assumed to have a power law dependence on radius).
...
%The density profile approaches an attractor solution $\rho(r,t) \rightarrow \rho(r)$.
...
%Returning to the possibility that protostellar jets may control the rate of star formation, \citet{2012ApJ...754...71K} found that proto-stellar jets did not reduce the star formation rate, while \citet{2014ApJ...790..128F} find that it might, under certain conditions.

%The numerical observation that protostellar feedback can, in certain simulations, reduce the star formation rate raises an important question in the context of the results of \citet{2015ApJ...800...49L}, MC15, and \citet{2017MNRAS.465.1316M}:
...
%We discuss our results, and our jet/protostellar radius algorithm, with that of previous workers in \S~\ref{sec:jet_previous}.
%We describe the effect of jet feedback on the morphology of the gas on parsec scales (\S~\ref{sec:jet_large scale}). and their relation to previous work in
We discuss our results in \S~\ref{sec:jet_discussion} and give our conclusions in \S~\ref{sec:jet_conclusions}.
%We discuss the implications of this work on the the large SFE, small scale accretion, and turbulence in molecular clouds in \S~\ref{sec:jet_discussion} and closed with some conclusions in \S~\ref{sec:jet_conclusions}.
